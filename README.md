...
| `infra/systemd` | Compose service unit |
...
This foundation does not implement managed-application telemetry, monitoring, log viewing, backups, Docker administration, or Portainer integration.
